...
class FiltersOfficeRentScreenen extends StatefulWidget {
  static const String routeName = '/real-estate-filters';

  const FiltersOfficeRentScreenen({super.key});

  @override
  State<FiltersOfficeRentScreenen> createState() =>
      _FiltersOfficeRentScreenenState();
}

class _FiltersOfficeRentScreenenState extends State<FiltersOfficeRentScreenen> {
