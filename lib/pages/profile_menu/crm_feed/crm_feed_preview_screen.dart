                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        // Значок «Ai» ставим по `aiRewritten`, а НЕ по
                        // `aiProcessed` (16.09.2026).
                        //
                        // `aiProcessed` означает «сгенерировано SEO», а SEO
                        // генерится ВСЕГДА, независимо от свича «ИИ изменит
                        // заголовок и описание». По нему значок появлялся и у
                        // объявлений с выключенным свичем, где текст остался
                        // оригинальным из фида.
                        //
                        // Раньше иначе и не получалось: `ai_rewritten` этот
                        // эндпоинт не отдавал вовсе. Теперь отдаёт. В списке
                        // своих объявлений значок уже рисовался правильно, и
                        // два экрана показывали разное про одно объявление.
