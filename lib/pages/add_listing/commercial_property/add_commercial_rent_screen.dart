...
class AddCommercialRentScreen extends StatefulWidget {
  ...
  const AddCommercialRentScreen({super.key, this.initialCategory});

  @override
  State<AddCommercialRentScreen> createState() =>
      _AddCommercialRentScreenState();
}

class _AddCommercialRentScreenState extends State<AddCommercialRentScreen> {
