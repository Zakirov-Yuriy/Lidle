...
class FiltersGarageRentScreen extends StatefulWidget {
  static const String routeName = '/real-estate-filters';

  const FiltersGarageRentScreen({super.key});

  @override
  State<FiltersGarageRentScreen> createState() =>
      _FiltersGarageRentScreenState();
}

class _FiltersGarageRentScreenState extends State<FiltersGarageRentScreen> {
