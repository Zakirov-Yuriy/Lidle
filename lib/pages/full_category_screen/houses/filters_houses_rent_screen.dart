...
class FiltersHousesRentScreenen extends StatefulWidget {
  static const String routeName = '/real-estate-filters';

  const FiltersHousesRentScreenen({super.key});

  @override
  State<FiltersHousesRentScreenen> createState() =>
      _FiltersHousesRentScreenenState();
}

class _FiltersHousesRentScreenenState extends State<FiltersHousesRentScreenen> {
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildSectionTitle('Вид обьекта'),
                    ...
                    _buildDropdown(
                      ...
                      onTap: () {
                        _openSelectionDialog(
                          ...
                          selected: _selectedWallTypes,
                          allowMultiple: false,
                          onChanged: (s) =>
                              setState(() => _selectedWallTypes = s),
                        );
                      },
                    ),
                    const SizedBox(height: 10),
