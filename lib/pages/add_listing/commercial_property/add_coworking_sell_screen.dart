...
/// ============================================================
/// Экран: Создание объявления — Продажа коворкингов
/// ============================================================
class AddCoworkingSellScreen extends StatefulWidget {
  static const String routeName = '/add-coworking-sell';

  final String? initialCategory;

  const AddCoworkingSellScreen({super.key, this.initialCategory});

  @override
  State<AddCoworkingSellScreen> createState() => _AddCoworkingSellScreenState();
}

class _AddCoworkingSellScreenState extends State<AddCoworkingSellScreen> {
  late String _selectedCategory;

  @override
  void initState() {
    super.initState();
    _selectedCategory = widget.initialCategory ?? 'Продажа коворкингов';
  }
  ...
  bool isRealtorWork = false; // Работа с риелторами
  bool isQuickBuyout = false; // Быстрый выкуп
          ...
          child: Column(
            ...
            children: [
              ...
              _buildTextField(
                ...
                hint: 'Например, коворкинг в центре города',
              ),
              ...
              _buildDropdown(
                ...
                subtitle:
                    'Недвижимость / Коммерчиская недвижимость / ${widget.initialCategory ?? 'Продажа коммерческой недвижимости'}',
                showChangeText: true,
                onTap: () async {
              ...
              _buildDropdown(
                ...
                onTap: () {
                  showDialog(
                    ...
                    builder: (context) {
                      return SelectionDialog(
                        title: 'Доступные типы помещения',
                        options: const [
