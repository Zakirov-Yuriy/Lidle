...
class FiltersCommercialPropertySellScreenen extends StatefulWidget {
  static const String routeName = '/real-estate-filters';

  const FiltersCommercialPropertySellScreenen({super.key});

  @override
  State<FiltersCommercialPropertySellScreenen> createState() =>
      _FiltersCommercialPropertySellScreenenState();
}

class _FiltersCommercialPropertySellScreenenState
    extends State<FiltersCommercialPropertySellScreenen> {
  ...
  bool? _selectedBathroom = true;
  bool? _selectedRenovation = true;
                    ...
                    _buildDropdown(
                      ...
                      onTap: () {
                        _openSelectionDialog(
                          ...
                          selected: _selectedComfortTypes,
                          allowMultiple: true,
                          onChanged: (s) =>
                              setState(() => _selectedComfortTypes = s),
                        );
                      },
                    ),
                    const SizedBox(height: 10),
