...
- **Категории и навигация**: Категоризированный просмотр с подкатегориями недвижимости, включая навигацию на экраны квартир при выборе соответствующей категории
- **Профили пользователей**: Управление личной панелью с избранным и объявлениями
- **Поиск и фильтры**: Продвинутый функционал поиска, фильтров и сортировки объявлений
