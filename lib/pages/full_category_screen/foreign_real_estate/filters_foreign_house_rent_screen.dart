...
class FiltersForeignHouseRentScreen extends StatefulWidget {
  static const String routeName = '/real-estate-filters';

  const FiltersForeignHouseRentScreen({super.key});

  @override
  State<FiltersForeignHouseRentScreen> createState() =>
      _FiltersForeignHouseRentScreenState();
}

class _FiltersForeignHouseRentScreenState
    extends State<FiltersForeignHouseRentScreen> {
