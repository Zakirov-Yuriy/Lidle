...
class UserMessagesListScreen extends StatefulWidget {
  const UserMessagesListScreen({super.key});

  static const String routeName = '/user-messages-list';
  ...
  @override
  State<UserMessagesListScreen> createState() => _UserMessagesListScreenState();
}

class _UserMessagesListScreenState extends State<UserMessagesListScreen> {
                                ...
                                children: [
                                  GestureDetector(
                                    ...
                                    child: Text(
                                      'Основные',
                                      style: TextStyle(
                                        color: isMainSelected ? UserMessagesListScreen.accentColor : Colors.white,
                                        fontSize: 15,
                                      ),
                                    ),
                                  ),
                                  ...
                                  GestureDetector(
                                    onTap: () {
                                      Navigator.pushNamed(context, UserMessagesArchiveListScreen.routeName);
                                    },
                                    child: Text(
                                      'Архив',
                                      style: TextStyle(
                                        color: isMainSelected ? Colors.white : UserMessagesListScreen.accentColor,
                                        fontSize: 15,
                                      ),
                                    ),
                                  ),
                                ...
                                children: [
                                  ...
                                  AnimatedPositioned(
                                    ...
                                    child: Container(
                                      ...
                                      color: UserMessagesListScreen.accentColor,
                                    ),
                                  ),
                                ],
                              ),
                            ...
                            children: [
                              ...
                              GestureDetector(
                                onTap: () {
                                  ...
                                  context.read<MessagesBloc>().add(ArchiveMessages(selectedIndices));
                                  setState(() {
                                ...
                                child: const Text(
                                  'В архив',
                                  style: TextStyle(color: UserMessagesListScreen.accentColor, fontSize: 14),
                                ),
                              ),
                            ],
                          ),
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: UserMessagesListScreen.cardColor,
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                  color: selected
                      ...
                      : UserMessagesListScreen.unreadBorder,
                ),
              ),
              child: Center(
                child: Text(
