...
/// ============================================================
class AddLandSellScreen extends StatefulWidget {
  static const String routeName = '/add-land-sell';

  const AddLandSellScreen({super.key});

  @override
  State<AddLandSellScreen> createState() => _AddLandSellScreenState();
}

class _AddLandSellScreenState extends State<AddLandSellScreen> {
  // ======================= СЕТЫ ДЛЯ ДИАЛОГОВ =======================
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildTextField(
                label: 'Общая площадь участка (соток)',
                hint: 'Цифрами',
                  ...
                  showDialog(
                    ...
                    builder: (context) {
                      return SelectionDialog(
                        ...
                        onSelectionChanged: (selected) {
                          setState(() => _selectedBuildingsOnPlot = selected);
                        },
                        allowMultipleSelection: true,
                      );
                    },
