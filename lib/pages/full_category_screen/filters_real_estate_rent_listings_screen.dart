...
class FiltersRealEstateRentListingsScreen extends StatefulWidget {
  ...
  const FiltersRealEstateRentListingsScreen({super.key});

  @override
  State<FiltersRealEstateRentListingsScreen> createState() =>
      _FiltersRealEstateRentListingsScreenState();
}
                    ...
                    _buildDropdown(
                      ...
                      onTap: () {
                        _openSelectionDialog(
                          ...
                          selected: _selectedSleepingPlaces,
                          allowMultiple: true,
                          onChanged: (s) =>
                              setState(() => _selectedSleepingPlaces = s),
                        );
                      },
                    ),
                    const SizedBox(height: 10),
