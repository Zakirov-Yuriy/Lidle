...
//
// Раньше та же логика работала ещё и в изоляте foreground-сервиса, чтобы
// соединение держалось у закрытого приложения. Тот сервис убран: доставку
// при закрытом приложении взял на себя Firebase (см. push_service.dart).
//
