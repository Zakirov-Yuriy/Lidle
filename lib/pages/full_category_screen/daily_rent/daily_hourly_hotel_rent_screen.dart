...
class DailyHourlyHotelRentScreen extends StatefulWidget {
  static const String routeName = '/real-estate-filters';

  const DailyHourlyHotelRentScreen({super.key});

  @override
  State<DailyHourlyHotelRentScreen> createState() =>
      _DailyHourlyHotelRentScreenState();
}

class _DailyHourlyHotelRentScreenState
    extends State<DailyHourlyHotelRentScreen> {
