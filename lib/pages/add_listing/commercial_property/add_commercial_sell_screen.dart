...
/// ============================================================
class AddCommercialSellScreen extends StatefulWidget {
  static const String routeName = '/add-commercial-sell';

  final String? initialCategory;

  const AddCommercialSellScreen({super.key, this.initialCategory});

  @override
  State<AddCommercialSellScreen> createState() =>
      _AddCommercialSellScreenState();
}

class _AddCommercialSellScreenState extends State<AddCommercialSellScreen> {
