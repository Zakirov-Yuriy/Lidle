// ============================================================
//  "Диалог отзыва на компанию (продавца)"
//  Открывается по тапу на звезду в блоке «Оставить оценку продавцу».
//  Оценка (1..5 звёзд) + текст. Шлёт POST /companies/{id}/reviews.
// ============================================================
...
/// Показать диалог отзыва на компанию. Возвращает true, если отзыв отправлен.
/// [initialRating] — звезда, на которую нажал пользователь (1..5).
Future<bool?> showCompanyReviewDialog({
...
class CompanyReviewDialog extends StatefulWidget {
  /// Id компании (= id пользователя-продавца).
  final int companyId;

  /// Название продавца/компании для заголовка «Отзыв на …».
  final String title;

  /// Начальная оценка (звезда, на которую нажали).
...
class _CompanyReviewDialogState extends State<CompanyReviewDialog> {
  late int _rating =
      widget.initialRating < 0 ? 0 : (widget.initialRating > 5 ? 5 : widget.initialRating);
          ...
          children: [
            ...
            TextField(
              ...
              decoration: InputDecoration(
                hintText: 'Расскажите о работе с продавцом',
                hintStyle: const TextStyle(color: Colors.white38),
                helperText: 'Без телефонов и ссылок, до 400 знаков',
