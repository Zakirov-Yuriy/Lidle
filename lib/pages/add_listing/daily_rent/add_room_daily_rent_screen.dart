...
/// ============================================================
/// Экран: Создание объявления — Посуточная аренда комнат
/// ============================================================
class AddRoomDailyRentScreen extends StatefulWidget {
  static const String routeName = '/add-room-daily-rent';

  const AddRoomDailyRentScreen({super.key});

  @override
  State<AddRoomDailyRentScreen> createState() => _AddRoomDailyRentScreenState();
}

class _AddRoomDailyRentScreenState extends State<AddRoomDailyRentScreen> {
  // ======================= СЕТЫ ДЛЯ ДИАЛОГОВ =======================
  ...
  bool _selectedNutrition = true; // Питание да/нет
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildDropdown(
                label: 'Категория',
                hint: 'Комнаты посуточно, почасово',
                subtitle: 'Недвижимость /Посуточная аренда жилья',
                showChangeText: true,
                onTap: () {
                  Navigator.push(
                    context,
              ...
              _buildCheckboxRow(
                ...
                value: isSharedRent,
                onChanged: (v) => setState(() => isSharedRent = v),
              ),
              const SizedBox(height: 12),
              _buildCheckboxRow(
              ...
              _buildCheckboxRow(
                title: 'Возможна сдача по часово',
                value: isHourlyAvailable,
                onChanged: (v) => setState(() => isHourlyAvailable = v),
              ),
              const SizedBox(height: 17),
              ...
              _buildDropdown(
                label: 'Инфраструктура (50 метров)*',
                ...
                onTap: () {
                  showDialog(
                    ...
                    builder: (BuildContext context) {
                      return SelectionDialog(
                        title: 'Инфраструктура (50 метров)',
                        options: const [
                          'Центор города',
