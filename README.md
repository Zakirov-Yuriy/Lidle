...
- ✅ **Корзина**: Доработана функция корзины и экран приглашения друзей
- ✅ **Управление объявлениями**: Реализованы экраны Активные/Неактивные объявления с полной логикой
- ✅ **Регистрация**: Улучшена функция регистрации через мобильные устройства
- ✅ **Отзывы**: Полностью реализованы экраны отзывов пользователей
- ✅ **Отклики**: Добавлены экраны откликов на объявления
- ✅ **Поддержка**: Реализован раздел поддержки с чатом и акциями
- ✅ **Сообщения**: Добавлена система сообщений с архивом и чатом
...
- Управление собственными объявлениями (активные/неактивные)
- Система отзывов и откликов
...
- Настройки профиля
- Личные данные и управление аккаунтом
...
- `MessagesBloc`: Управляет сообщениями и чатом (новое)
- `SupportBloc`: Управляет поддержкой и акциями (новое)
- `ReviewsBloc`: Управляет отзывами пользователей (новое)
