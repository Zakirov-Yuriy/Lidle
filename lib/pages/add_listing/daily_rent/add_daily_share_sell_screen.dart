...
/// ============================================================
/// Экран: Создание объявления — Продажа ежедневных долей
/// ============================================================
class AddDailyShareSellScreen extends StatefulWidget {
  static const String routeName = '/add-land-sell';

  const AddDailyShareSellScreen({super.key});

  @override
  State<AddDailyShareSellScreen> createState() =>
      _AddDailyShareSellScreenState();
}

class _AddDailyShareSellScreenState extends State<AddDailyShareSellScreen> {
  // ======================= СЕТЫ ДЛЯ ДИАЛОГОВ =======================
              ...
              _buildDropdown(
                ...
                onTap: () {
                  showDialog(
                    ...
                    builder: (context) {
                      return SelectionDialog(
                        title: 'Расстояние до ближайшего города',
                        options: const [
                          'В городе',
                          'До 5 км',
                          'До 10 км',
