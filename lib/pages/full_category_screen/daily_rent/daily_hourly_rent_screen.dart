...
class DailyHourlyRentScreen extends StatefulWidget {
  static const String routeName = '/real-estate-filters';

  const DailyHourlyRentScreen({super.key});

  @override
  State<DailyHourlyRentScreen> createState() => _DailyHourlyRentScreenState();
}

class _DailyHourlyRentScreenState extends State<DailyHourlyRentScreen> {
