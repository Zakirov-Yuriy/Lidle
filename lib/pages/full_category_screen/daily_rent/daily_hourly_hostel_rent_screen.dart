...
class DailyHourlyHostelRentScreen extends StatefulWidget {
  static const String routeName = '/real-estate-filters';

  const DailyHourlyHostelRentScreen({super.key});

  @override
  State<DailyHourlyHostelRentScreen> createState() =>
      _DailyHourlyHostelRentScreenState();
}

class _DailyHourlyHostelRentScreenState
    extends State<DailyHourlyHostelRentScreen> {
