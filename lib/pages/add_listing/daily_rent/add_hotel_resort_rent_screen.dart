...
/// ============================================================
/// Экран: Создание объявления — Аренда отелей и курортов
/// ============================================================
class AddHotelResortRentScreen extends StatefulWidget {
  static const String routeName = '/add-land-sell';

  const AddHotelResortRentScreen({super.key});

  @override
  State<AddHotelResortRentScreen> createState() =>
      _AddHotelResortRentScreenState();
}

class _AddHotelResortRentScreenState extends State<AddHotelResortRentScreen> {
  // ======================= СЕТЫ ДЛЯ ДИАЛОГОВ =======================
          ...
          child: Column(
            ...
            children: [
              ...
              _buildCheckboxRow(
                ...
                value: isHourlyRent,
                onChanged: (v) => setState(() => isHourlyRent = v),
              ),
              const SizedBox(height: 12),
              _buildCheckboxRow(
                title: 'Перелет с детьми',
                value: isFlightWithChildren,
                onChanged: (v) => setState(() => isFlightWithChildren = v),
              ),
              const SizedBox(height: 12),
              _buildCheckboxRow(
                  ...
                  showDialog(
                    ...
                    builder: (BuildContext context) {
                      return SelectionDialog(
                        ...
                        options: const ['Эконом', 'Комфорт', 'Бизнес', 'Элит'],
