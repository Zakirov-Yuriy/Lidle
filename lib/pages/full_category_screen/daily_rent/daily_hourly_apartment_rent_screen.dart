...
class DailyHourlyApartmenRentScreen extends StatefulWidget {
  static const String routeName = '/real-estate-filters';

  const DailyHourlyApartmenRentScreen({super.key});

  @override
  State<DailyHourlyApartmenRentScreen> createState() =>
      _DailyHourlyApartmenRentScreenState();
}

class _DailyHourlyApartmenRentScreenState
    extends State<DailyHourlyApartmenRentScreen> {
