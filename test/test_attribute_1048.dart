...
void main() async {
  ...
  print('🧪 Testing Attribute 1048 (Вам предложат цену) - CORRECT FORMAT');
  print('═══════════════════════════════════════════════════════════\n');
  ...
  // ✅ CORRECT FORMAT: attribute_1048 at TOP-LEVEL
  final correctPayload = {
    'name': 'Тестовая квартира для проверки 1048',
    'description':
    ...
    // ✅ attribute_1048 at TOP LEVEL (KEY FIX!)
    'attribute_1048': true,
    ...
    'attributes': {
      ...
      'values': {
        ...
        '1127': {'value': 50, 'max_value': 100}, // REQUIRED range attribute
      },
    },
    'is_auto_renew': false,
  };
  ...
  print('   • attribute_1048 at TOP-LEVEL: ✅');
  print('   • attributes.value_selected: ✅');
  print('   • attributes.values: ✅');
  print('   • address.region_id: ✅');
  print('\n📤 Sending request...\n');
