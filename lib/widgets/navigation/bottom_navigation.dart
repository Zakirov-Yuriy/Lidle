      ...
      child: InkWell(
        ...
        child: Stack(
          children: [
            ...
            // Значок с числом: непрочитанные сообщения и позиции в корзине.
            //
            // Корзина (индекс 3) сюда добавлена 15.09.2026. Число ей
            // передавали и раньше, но рисовался значок только у сообщений, и
            // счётчик корзины в нижнем меню не появлялся никогда. Заметили,
            // когда с витрины убрали корзину из шапки и её работа целиком
            // перешла вниз.
            if ((index == 4 || index == 3) && unreadCount > 0)
              Positioned(
                top: 0,
                right: 0,
                child: Container(
