...
/// ============================================================
/// Экран: Создание объявления — Аренда мест в хостелах
/// ============================================================
class AddHostelBedRentScreen extends StatefulWidget {
  static const String routeName = '/add-land-sell';

  const AddHostelBedRentScreen({super.key});

  @override
  State<AddHostelBedRentScreen> createState() =>
      _AddHostelBedRentScreenState();
}

class _AddHostelBedRentScreenState extends State<AddHostelBedRentScreen> {
  // ======================= СЕТЫ ДЛЯ ДИАЛОГОВ =======================
