...
class FiltersRoomShellScreen extends StatefulWidget {
  static const String routeName = '/real-estate-filters';

  const FiltersRoomShellScreen({super.key});

  @override
  State<FiltersRoomShellScreen> createState() => _FiltersRoomShellScreenState();
}

class _FiltersRoomShellScreenState extends State<FiltersRoomShellScreen> {
