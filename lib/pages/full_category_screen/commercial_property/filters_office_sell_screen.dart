...
class FiltersOfficeSellScreenen extends StatefulWidget {
  static const String routeName = '/real-estate-filters';

  const FiltersOfficeSellScreenen({super.key});

  @override
  State<FiltersOfficeSellScreenen> createState() =>
      _FiltersOfficeSellScreenenState();
}

class _FiltersOfficeSellScreenenState extends State<FiltersOfficeSellScreenen> {
