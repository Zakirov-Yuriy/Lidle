...
class FiltersRoomRentScreen extends StatefulWidget {
  static const String routeName = '/real-estate-filters';

  const FiltersRoomRentScreen({super.key});

  @override
  State<FiltersRoomRentScreen> createState() => _FiltersRoomRentScreenState();
}

class _FiltersRoomRentScreenState extends State<FiltersRoomRentScreen> {
