...
/// дома». Папки бывают только те, что человек завёл сам: товар, добавленный
/// без выбора, лежит в корзине общим списком и ни в какой папке не состоит.
///
/// Пункт «Без папки» в диалогах — это НЕ папка, а её отсутствие: у него
/// пустой номер, и создаётся он самим диалогом.
class CartFolderInfo {
  ...
  /// Это пункт «Без папки», а не настоящая полка.
  final bool isMain;
