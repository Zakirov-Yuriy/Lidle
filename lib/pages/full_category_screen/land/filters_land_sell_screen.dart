...
class FiltersLandSellScreenen extends StatefulWidget {
  static const String routeName = '/real-estate-filters';

  const FiltersLandSellScreenen({super.key});

  @override
  State<FiltersLandSellScreenen> createState() =>
      _FiltersLandSellScreenenState();
}

class _FiltersLandSellScreenenState extends State<FiltersLandSellScreenen> {
