...
class UserMessagesArchiveListScreen extends StatefulWidget {
  const UserMessagesArchiveListScreen({super.key});

  static const String routeName = '/user-messages-archive-list';
  ...
  @override
  State<UserMessagesArchiveListScreen> createState() => _UserMessagesArchiveListScreenState();
}

class _UserMessagesArchiveListScreenState extends State<UserMessagesArchiveListScreen> {
                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  GestureDetector(
                                    onTap: () {
                                      Navigator.pushNamed(context, UserMessagesListScreen.routeName);
                                    },
                                    child: Text(
                                      'Основные',
                                      style: TextStyle(
                                        color: isMainSelected ? UserMessagesArchiveListScreen.accentColor : Colors.white,
                                        fontSize: 15,
                                      ),
                                    ),
                                  ),
                                  ...
                                  GestureDetector(
                                    ...
                                    child: Text(
                                      'Архив',
                                      style: TextStyle(
                                        color: isMainSelected ? Colors.white : UserMessagesArchiveListScreen.accentColor,
                                        fontSize: 15,
                                      ),
                                    ),
                                  ),
                                ...
                                children: [
                                  ...
                                  AnimatedPositioned(
                                    ...
                                    child: Container(
                                      ...
                                      color: UserMessagesArchiveListScreen.accentColor,
                                    ),
                                  ),
                                ],
                              ),
                            ...
                            children: [
                              ...
                              GestureDetector(
                                onTap: () {
                                  ...
                                  context.read<MessagesBloc>().add(UnarchiveMessages(selectedIndices));
                                  setState(() {
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: UserMessagesArchiveListScreen.cardColor,
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                  color: selected
                      ? UserMessagesArchiveListScreen.accentColor
                      : UserMessagesArchiveListScreen.unreadBorder,
                ),
              ),
              child: Center(
                child: Text(
