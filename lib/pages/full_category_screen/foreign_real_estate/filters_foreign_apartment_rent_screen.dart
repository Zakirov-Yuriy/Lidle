...
class FiltersForeignApartmentRentScreen extends StatefulWidget {
  static const String routeName = '/real-estate-filters';

  const FiltersForeignApartmentRentScreen({super.key});

  @override
  State<FiltersForeignApartmentRentScreen> createState() =>
      _FiltersForeignApartmentRentScreenState();
}

class _FiltersForeignApartmentRentScreenState
    extends State<FiltersForeignApartmentRentScreen> {
