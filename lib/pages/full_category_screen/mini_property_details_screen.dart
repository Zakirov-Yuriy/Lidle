...
import 'package:lidle/pages/full_category_screen/share_property_screen.dart'; // Import share_property_screen
                  ...
                  IconButton(
                    ...
                    onPressed: () {
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) =>
                              const ShapePublicationSuccessScreen(),
                        ),
                      );
                    },
                  ),
        ...
        Navigator.push(
          ...
          MaterialPageRoute(
            builder: (context) => SellerProfileScreen(
              ...
              sellerAvatar: const AssetImage("assets/property_details_screen/Andrey.png"),
              sellerListings: similarListings.map((listing) => {
                "id": listing.id,
