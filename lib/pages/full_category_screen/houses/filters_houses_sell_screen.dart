...
class FiltersHousesShellScreenen extends StatefulWidget {
  static const String routeName = '/real-estate-filters';

  const FiltersHousesShellScreenen({super.key});

  @override
  State<FiltersHousesShellScreenen> createState() =>
      _FiltersHousesShellScreenenState();
}

class _FiltersHousesShellScreenenState
    extends State<FiltersHousesShellScreenen> {
