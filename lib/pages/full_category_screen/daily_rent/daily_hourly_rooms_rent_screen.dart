...
class DailyHourlyRoomsRentScreen extends StatefulWidget {
  static const String routeName = '/real-estate-filters';

  const DailyHourlyRoomsRentScreen({super.key});

  @override
  State<DailyHourlyRoomsRentScreen> createState() =>
      _DailyHourlyRoomsRentScreenState();
}

class _DailyHourlyRoomsRentScreenState
    extends State<DailyHourlyRoomsRentScreen> {
