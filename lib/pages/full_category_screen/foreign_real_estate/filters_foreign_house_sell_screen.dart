...
class FiltersForeignHouseSellScreen extends StatefulWidget {
  static const String routeName = '/real-estate-filters';

  const FiltersForeignHouseSellScreen({super.key});

  @override
  State<FiltersForeignHouseSellScreen> createState() =>
      _FiltersForeignHouseSellScreenState();
}

class _FiltersForeignHouseSellScreenState
    extends State<FiltersForeignHouseSellScreen> {
        ...
        Expanded(
          child: OutlinedButton(
            ...
            child: Text(
              labelYes,
              style: TextStyle(
                color: selected == true ? Colors.white : textPrimary,
                fontSize: 14,
              ),
            ),
          ),
        ...
        Expanded(
          child: OutlinedButton(
            ...
            child: Text(
              labelNo,
              style: TextStyle(
                color: selected == false ? Colors.white : textPrimary,
                fontSize: 14,
              ),
            ),
          ),
