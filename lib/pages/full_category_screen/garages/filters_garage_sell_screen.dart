...
class FiltersGarageSellScreen extends StatefulWidget {
  static const String routeName = '/real-estate-filters';

  const FiltersGarageSellScreen({super.key});

  @override
  State<FiltersGarageSellScreen> createState() =>
      _FiltersGarageSellScreenState();
}

class _FiltersGarageSellScreenState extends State<FiltersGarageSellScreen> {
