...
class AddLandRentScreen extends StatefulWidget {
  ...
  @override
  State<AddLandRentScreen> createState() => _AddLandRentScreenState();
}

class _AddLandRentScreenState extends State<AddLandRentScreen> {
  // ======================= СЕТЫ ДЛЯ ДИАЛОГОВ =======================
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildDropdown(
                label: 'Категория',
                hint: 'Долгосрочная аренда земля',
