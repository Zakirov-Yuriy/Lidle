...
/// ============================================================
/// Экран: Создание объявления — Предложения туроператоров
/// ============================================================
class AddTourOperatorOfferScreen extends StatefulWidget {
  static const String routeName = '/add-land-sell';

  const AddTourOperatorOfferScreen({super.key});

  @override
  State<AddTourOperatorOfferScreen> createState() =>
      _AddTourOperatorOfferScreenState();
}

class _AddTourOperatorOfferScreenState
    extends State<AddTourOperatorOfferScreen> {
  // ======================= СЕТЫ ДЛЯ ДИАЛОГОВ =======================
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildDropdown(
                label: 'Категория',
                hint: 'Предложения туроператоров',
